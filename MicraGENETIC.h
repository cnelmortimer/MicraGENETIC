...
#include "OperadoresSeleccion.h"//Distintas opciones al proceso de seleccion de reprocutores
...
template <class T> void MicraGENETIC<T>::escogerReproducirMutar(){
    switch(opSelector){//Alternativa: Usar "Punteros a funciones"
        case SelRuleta:
            seleccionRuleta(poblacion, valorTotalPoblacion, nIndividuos, nDescendientes, probabilidadMutacion,
                                           descendencia); break;
        case SelAleatorioPuro:
            seleccionAleatoriaPura(poblacion, nIndividuos, nDescendientes, probabilidadMutacion,
                                   descendencia); break;
        case SelTorneo:
            seleccionPorTorneo(poblacion, nIndividuos, nDescendientes, tTorneo, probabilidadMutacion,
                               descendencia);
            break;
    }
